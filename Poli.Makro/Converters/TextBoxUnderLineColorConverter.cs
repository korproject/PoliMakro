...
{
    class TextBoxUnderLineColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (!string.IsNullOrEmpty(value?.ToString()))
            {
                ...
                {
                    // Mat Color Purple:500
                    ret = "#9C27B0";
                }
                else if (vallenght >= 6 && vallenght <= 8)
                {
                    // Mat Color Indigo:500
                    ret = "#3F51B5";
                }
                ...
                else if (vallenght >= 32 && vallenght <= 35)
                {
                    // Mat Color Blue:800
                    ret = "#1565C0";
                }
                else if (vallenght > 36)
                {
                    // Mat Color Blue Grey:800
                    ret = "#37474F";
                }
            }
